...
<template>
  <div class="mt-4 grid grid-cols-4 gap-4">
    <TrendCard
      ...
      :indicator-desc="
        props.companyScaleName
          ? props.companyScaleName + '单位招聘需求总人数'
          : '标准单位招聘需求总人数'
      "
      quantifier="人"
    ...
    <TrendCard
      ...
      :indicator-desc="
        props.companyScaleName
          ? props.companyScaleName + '单位招聘职位总个数'
          : '标准单位招聘职位总个数'
      "
      quantifier="个"
      :chart-data="chartData"
    ...
    <TrendCard
      ...
      :value="8500"
      :indicator-desc="
        props.companyScaleName ? props.companyScaleName + '单位薪资中位数' : '标准单位薪资中位数'
      "
      quantifier="元"
      :chart-data="chartData"
      :colors="['#FFA940']"
    ...
    <TrendCard
      ...
      :indicator-desc="
        props.companyScaleName
          ? props.companyScaleName + '单位招聘单位总个数'
          : '标准单位招聘单位总个数'
      "
      quantifier="个"
      :chart-data="chartData"
