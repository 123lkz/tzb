...
const tooltipFormatter = (params: any) => {
  ...
  return `
    <div class="font-bold text-gray-800 text-xs w-[300px]">
      ${params.name} ${
    props.industryLabel
      ? props.industryLabel + '(' + industryCategoryMap[props.industryLevel] + ')'
      : '标准'
  }行业招聘概览
    </div>
    <div class="flex items-center mt-2 text-xs">
      <span class="inline-block w-3 h-3 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full mr-2"></span>
      <span class="text-gray-700">${props.industryLabel ? '该' : '标准'}行业招聘总个数排行：</span>
      <span class="font-bold font-DIN-Medium text-blue-600">第${item.group}名</span>
    </div>
    <div class="flex items-center mt-2 text-xs">
      <span class="inline-block w-3 h-3 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full mr-2"></span>
      <span class="text-gray-700">${props.industryLabel ? '该' : '标准'}行业招聘总个数：</span>
    ...
    <div class="flex items-center mt-2 text-xs">
      <span class="inline-block w-3 h-3 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full mr-2"></span>
      <span class="text-gray-700">${props.industryLabel ? '该' : '标准'}行业的招聘职位个数：</span>
      <span class="font-bold font-DIN-Medium text-blue-600">${(
        item.value ?? 0
    ...
    <div class="flex items-center mt-2 text-xs">
      <span class="inline-block w-3 h-3 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full mr-2"></span>
      <span class="text-gray-700">${props.industryLabel ? '该' : '标准'}行业的招聘总人数：</span>
      <span class="font-bold font-DIN-Medium text-blue-600">${(
        item.value ?? 0
    ...
    <div class="flex items-center mt-2 text-xs">
      <span class="inline-block w-3 h-3 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full mr-2"></span>
      <span class="text-gray-700">${props.industryLabel ? '该' : '标准'}行业的薪资中位数：</span>
      <span class="font-bold font-DIN-Medium text-blue-600">${(
        item.value ?? 0
  ...
  <div class="w-full h-[640px] mb-4 flex mt-4">
    <div class="w-[21%] h-full grid grid-cols-1 grid-rows-2 gap-4">
      <RankCard
        ...
        :tooltip-title="`${props.industryLabel}行业招聘总个数`"
        :indicator-desc="`${props.industryLabel}行业招聘总个数`"
        :grid="{
          top: '3%',
        }"
      />
      <RankCard
        ...
        :tooltip-title="`${props.industryLabel}行业招聘总人数`"
        :grid="{
          top: '3%',
        }"
      />
    ...
    <div class="w-[21%] h-full grid grid-cols-1 grid-rows-2 gap-4">
      <RankCard
        ...
        :tooltip-title="`${props.industryLabel}行业薪资中位数`"
        :grid="{
          top: '3%',
        }"
      />
      <RankCard
        ...
        chart-height="230px"
        :chart-data="chartData"
        :tooltip-title="`${props.industryLabel}行业招聘单位数`"
        :grid="{
          top: '3%',
        }"
      />
