...
class ZhilianCollectionAnalyzer:
    def __init__(self):
        # MongoDB配置
        ...
        self.collection_groups = [
            {
                'url_part': 'zhilian_step2_urls_part1',
                'log_part': 'zhilian_step2_urls_202504_log_part1'
            },
            {
                'url_part': 'zhilian_step2_urls_part2', 
                'log_part': 'zhilian_step2_urls_202504_log_part2'
            },
            {
                'url_part': 'zhilian_step2_urls_part3',
                'log_part': 'zhilian_step2_urls_202504_log_part3'
            },
            {
                'url_part': 'zhilian_step2_urls_part4',
                'log_part': 'zhilian_step2_urls_202504_log_part4'
            }
        ]
    ...
    def analyze_collection_group(self, url_collection, log_collection):
        ...
        if only_in_log:
            ...
            for i, doc in enumerate(only_in_log[:5]):  # 只显示前5个
                ...
                print(f"     行业: {doc.get('industry_name', 'N/A')}")
                print(f"     城市: {doc.get('city_name', 'N/A')}")
...
def main():
    analyzer = ZhilianCollectionAnalyzer()
    try:
        # 运行分析
